...
/// lives, and about nothing downstream of that. <see cref="ColladaImporter.HackyImportCollada"/>
/// and <see cref="ObjImporter.Import"/> return bare meshes instead, which is all a static
/// model needs.
/// </summary>
